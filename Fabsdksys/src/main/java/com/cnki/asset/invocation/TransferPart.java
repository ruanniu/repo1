...
public class TransferPart {
	...
	private static TransferProposal createTransferProposal() {
		...
		//1、先设置交易权利描述：基本信息
		transactionRights.setPkri("Pkri1002");//确权标识
		transactionRights.setVersion("1.0");//设置版本
		transactionRights.setTransactionType("原始部分转让"); //设置交易类型：原始部分转让
		...
		proposal.setTpkrai("pkrai101_tran3"); //生成资产标识
		proposal.setTpkrai1("pkrai101_tran4"); //生成资产标识
