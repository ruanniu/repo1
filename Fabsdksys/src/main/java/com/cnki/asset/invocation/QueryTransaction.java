...
public class QueryTransaction {
	...
	public static void main(String args[]) {
		try {
			...
			adminUserContext.setName(Config.ADMIN);   //新注册的节点名称    
			...
			//***第六步：通过通道客户端实现链码查询		
			Collection<ProposalResponse>  responsesQuery = channelClient.queryByChainCode("mycc", "queryTran", new String[] {"pkr101"});
