...
import com.cnki.asset.proposal.PermitCancelProposal;

import net.sf.json.JSONObject;
import net.sf.json.JsonConfig;

//权利许可到期/撤销
public class PermitCancel{
	...
	public static void main(String args[]) {
		try {
			...
			request.setFcn("permitCancel");
									
			//构建资产登记议案			
			PermitCancelProposal proposal = new PermitCancelProposal("许可撤销", "pkri111", "pkrai101", "tpkrai101", "certificate111");					  
