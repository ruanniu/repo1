...
public class CAClient {
	...
	public String registerUser(String username, String organization) throws Exception {
		...
		//给注册用户添加一个属性
		rr.addAttribute(new Attribute("user", "register",true));
